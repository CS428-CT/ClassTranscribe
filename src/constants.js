...
export const NO_COURSES = `No courses to display`
export const NO_STARRED_COURSES = `No starred courses to display`
export const NO_HISTORY = `No Watched video to display`

export const REDUCER_ACTIONS = {
  SET_LOADING: 'SET_LOADING',
  UPDATE_EFFECT_STAUSES: 'UPDATE_STATUSES',
}
